...
Purpose:
    Run the combined algorithm that solves the VeRolog problem
...
def findIndexReq(request,clusterRequestMatrix):
    ...
    return index
###########################################################
### called in makeDeliverySchedule()
...
###########################################################
### called in main()
def combineRoutes(scheduleCombined,deliveryRoutes,Graph,constraints,requests,machines,numberRequests,numberMachines):
    '''
    Purpose:
...
def main():
    ...
    scheduleDeliveryCombined = combineRoutes(scheduleCombined,deliveryRoutes,Graph,constraints,requests,machines,numberRequests,numberMachines)
    ...
    #python SolutionVerolog2019.py -i VSC2019_ORTEC_early_13.txt -s TestSolutionFileCombined.txt
